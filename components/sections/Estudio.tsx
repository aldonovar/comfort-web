...
export default function Estudio() {
  ...
  return (
    <section ref={sectionRef} id="estudio" className="relative bg-neutral-950 text-white overflow-hidden">
      ...
      */}
      <div ref={containerRef} className="flex flex-row w-[400vw] h-[100dvh] will-change-transform">
        ...
        <div className="horizontal-panel w-screen h-[100dvh] flex flex-col justify-center items-center bg-neutral-950 text-white relative z-10 shrink-0 border-r border-white/5">
          ...
          <div className="max-w-5xl px-8 md:px-6 text-center relative z-10 flex flex-col items-center">
            ...
            <p className="text-lg md:text-3xl text-white/60 max-w-sm md:max-w-2xl mx-auto leading-relaxed text-balance">
        ...
        {/* --- PANEL 2: ENFOQUE --- */}
        <div className="horizontal-panel w-screen h-[100dvh] flex flex-col justify-center md:justify-end pb-0 md:pb-24 bg-neutral-950 relative z-20 shrink-0 border-r border-white/5 overflow-hidden group">
          <Image
          ...
          <div className="max-w-[1800px] w-full mx-auto px-8 md:px-12 relative z-10 text-center md:text-left">
            ...
            <p className="panel-anim text-base md:text-2xl text-white/70 max-w-sm md:max-w-2xl mx-auto md:mx-0 leading-relaxed text-balance">
        ...
        {/* --- PANEL 3: OBSESIÓN --- */}
        <div className="horizontal-panel w-screen h-[100dvh] flex flex-col justify-center md:justify-end pb-0 md:pb-24 bg-neutral-950 relative z-30 shrink-0 border-r border-white/5 overflow-hidden group">
          <Image
