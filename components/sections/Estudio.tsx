...
export default function Estudio() {
    ...
    let ctx = gsap.context(() => {
      ...
      const scrollTween = gsap.to(sections, {
        ...
        scrollTrigger: {
          ...
          pin: true,
          scrub: 0.5,
          start: "top top", // Crucial: Pin exactly when section hits top
          end: () => `+=${window.innerWidth * (window.innerWidth < 768 ? 2 : 3)}`,
          snap: {
            snapTo: 1 / (totalSections - 1),
            duration: { min: 0.2, max: 0.4 },
            delay: 0.2, // Small delay for natural feel
            ease: "power1.inOut"
          },
          invalidateOnRefresh: true,
          anticipatePin: 1, // Smoothing for mobile
        }
      });
  ...
  return (
    <section ref={sectionRef} id="estudio" className="relative bg-black text-white overflow-hidden">
      ...
      */}
      <div ref={containerRef} className="flex flex-row w-[400vw] h-[100dvh]">
        ...
        <div className="horizontal-panel w-screen h-[100dvh] flex flex-col justify-center items-center bg-primary text-primary relative z-10 shrink-0 border-r border-white/5">
          ...
          <div className="max-w-5xl px-8 md:px-6 text-center relative z-10 flex flex-col items-center">
            ...
            <div className="panel-anim flex justify-center items-center gap-4 mb-6 lg:mb-12">
            ...
            <h2 className="panel-anim font-serif text-4xl md:text-8xl lg:text-9xl leading-[1.1] md:leading-[0.9] mb-6 lg:mb-12">
              No hacemos <br />
              <span className="text-terracota italic">terrazas.</span>
            </h2>

            <p className="panel-anim text-lg md:text-3xl text-primary/60 max-w-sm md:max-w-2xl mx-auto leading-relaxed text-balance">
            ...
            <div className="mt-8 md:mt-12 panel-anim animate-pulse">
        ...
        {/* --- PANEL 2: ENFOQUE --- */}
        {/* Changed justify-end to justify-center for mobile safe-area framing */}
        ...
        <div className="horizontal-panel w-screen h-[100dvh] flex flex-col justify-center bg-terracota text-white relative z-40 shrink-0">
          ...
          <div className="max-w-[1800px] w-full mx-auto px-8 md:px-12 relative z-10 grid md:grid-cols-2 gap-8 md:gap-16 items-center text-center md:text-left">
            <div>
              ...
              <Link href="/nosotros" className="panel-anim group relative inline-flex px-8 py-3.5 md:py-4 bg-white text-terracota rounded-full overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95">
