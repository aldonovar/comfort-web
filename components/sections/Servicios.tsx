...
export default function Servicios() {
  ...
  return (
    <section
      ref={sectionRef}
      id="servicios"
      className="relative py-16 md:py-24 bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-[var(--bg-secondary)] via-[var(--bg-primary)] to-[var(--bg-primary)] text-[var(--text-primary)] overflow-hidden transition-colors duration-500"
    >
