        ...
        <div className="max-w-2xl mx-auto bg-white/50 dark:bg-white/5 backdrop-blur-xl border border-(--text-primary)/5 rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/5 dark:shadow-black/50 transition-all duration-500 hover:shadow-black/10 dark:hover:shadow-black/70 hover:-translate-y-1">
          ...
          <div className="grid gap-4">
            ...
            <a
              ...
              className="group flex items-center justify-between p-5 rounded-2xl bg-(--text-primary)/5 hover:bg-(--text-primary)/10 border border-transparent hover:border-(--text-primary)/5 transition-all duration-300"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-serif text-lg text-(--text-primary)">WhatsApp</h4>
                  <p className="text-[10px] uppercase tracking-wider text-(--text-primary)/50">Respuesta Inmediata</p>
                </div>
              </div>
