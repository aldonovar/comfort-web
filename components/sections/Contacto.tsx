        ...
        <div className="max-w-5xl mx-auto bg-white/50 dark:bg-white/5 backdrop-blur-xl border border-(--text-primary)/5 rounded-3xl p-8 shadow-2xl shadow-black/5 dark:shadow-black/50 transition-all duration-500 hover:shadow-black/10 dark:hover:shadow-black/70 hover:-translate-y-1">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <a
              ...
              className="group flex flex-col md:flex-row items-center md:items-start justify-between p-4 rounded-xl bg-(--text-primary)/5 hover:bg-(--text-primary)/10 border border-transparent hover:border-(--text-primary)/5 transition-all duration-300 text-center md:text-left gap-3 md:gap-0"
            >
              <div className="flex flex-col md:flex-row items-center gap-3">
                ...
                <div>
                  <h4 className="font-serif text-base text-(--text-primary)">WhatsApp</h4>
                  <p className="text-[9px] uppercase tracking-wider text-(--text-primary)/50">Respuesta Inmediata</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex flex-col md:flex-row items-center gap-3">
                ...
                <div>
                  <h4 className="font-serif text-base text-(--text-primary)">Email</h4>
                  <p className="text-[9px] uppercase tracking-wider text-(--text-primary)/50">Propuestas Formales</p>
                </div>
              </div>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col md:flex-row items-center md:items-start justify-between p-4 rounded-xl bg-terracota/5 hover:bg-terracota/10 border border-terracota/10 hover:border-terracota/20 transition-all duration-300 text-center md:text-left gap-3 md:gap-0"
            >
              <div className="flex flex-col md:flex-row items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-terracota/10 flex items-center justify-center text-terracota group-hover:scale-110 transition-transform">
                ...
                <div>
                  <h4 className="font-serif text-base text-(--text-primary)">Agendar</h4>
                  <p className="text-[9px] uppercase tracking-wider text-terracota">Videollamada</p>
                </div>
              </div>
            </a>
