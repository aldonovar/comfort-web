...
export default function Contacto() {
  ...
  return (
    <section
      ref={sectionRef}
      id="contacto"
      className="relative bg-[var(--bg-primary)] text-[var(--text-primary)] py-32 transition-colors duration-500 overflow-hidden"
    >
      {/* Background Ambience */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* The Business Card */}
        <div className="max-w-2xl mx-auto bg-white/50 dark:bg-white/5 backdrop-blur-xl border border-[var(--text-primary)]/5 rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/5 dark:shadow-black/50 transition-all duration-500 hover:shadow-black/10 dark:hover:shadow-black/70 hover:-translate-y-1">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-[var(--text-primary)]/60 text-sm max-w-md mx-auto">
          ...
          <div className="grid gap-4">
            ...
            className="group flex items-center justify-between p-5 rounded-2xl bg-[var(--text-primary)]/5 hover:bg-[var(--text-primary)]/10 border border-transparent hover:border-[var(--text-primary)]/5 transition-all duration-300"
            >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-serif text-lg text-[var(--text-primary)]">WhatsApp</h4>
                <p className="text-[10px] uppercase tracking-wider text-[var(--text-primary)]/50">Respuesta Inmediata</p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-serif text-lg text-[var(--text-primary)]">Email</h4>
              <p className="text-[10px] uppercase tracking-wider text-[var(--text-primary)]/50">Propuestas Formales</p>
            </div>
          </div>
          <span className="text-madera/20 dark:text-crema/20 group-hover:text-terracota transition-colors">→</span>
        </a>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-serif text-lg text-[var(--text-primary)]">Agendar Reunión</h4>
              <p className="text-[10px] uppercase tracking-wider text-terracota">Videollamada 30 min</p>
            </div>
          </div>
          <span className="text-terracota group-hover:text-[var(--text-primary)] transition-colors">Reservar</span>
        </a>

      </div>

      {/* Footer */}
      <div className="mt-8 pt-8 border-t border-[var(--text-primary)]/5 text-center">
        <p className="text-[10px] uppercase tracking-[0.2em] text-[var(--text-primary)]/30">
