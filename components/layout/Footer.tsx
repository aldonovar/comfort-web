          ...
          <div className="md:col-span-4 space-y-8 footer-reveal">
            ...
            <div className="flex gap-4">
              {[
                ...
                { d: "M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v6.14c0 3.48-2.32 6.66-5.79 7.63-3.23.91-6.85-.05-9.28-2.48-2.42-2.43-3.37-6.05-2.46-9.28.91-3.23 3.66-5.86 6.91-6.59 1.09-.24 2.23-.24 3.32-.01v4.2c-1.19-.06-2.35.44-3.14 1.35-1.01 1.18-1.07 2.95-.02 4.02 1.05 1.07 2.82 1.13 4.01.03.91-.79 1.41-1.95 1.35-3.14 0-.08 0-.16 0-.24V.02z", href: "https://www.tiktok.com/@comfortstudioperu" },
