...
const MEGA_CONTENT: any = {
  ...
  proyectos: {
    defaultImage: "/projects/project-1.jpg",
    items: [
      {
      ...
      >
        <div className="max-w-[1800px] mx-auto px-6 md:px-12 flex items-center justify-between relative z-50">
          ...
          <div className="hidden xl:flex items-center gap-6">
            ...
            <Button
              href="/cotiza"
              variant={scrolled || activeMega ? "primary" : "outline"}
              className={`transition-colors duration-300 ${scrolled || activeMega ? "bg-[var(--text-primary)] text-[var(--bg-primary)] hover:text-white" : ""}`}
            >
