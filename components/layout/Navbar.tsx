          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex flex-col items-end">
              ...
              <a
                ...
                className={`flex items-center gap-2 text-xs font-bold transition-colors duration-300 ${scrolled || activeMega ? "text-white hover:text-terracota" : "text-white hover:text-terracota"
                  }`}
              >
